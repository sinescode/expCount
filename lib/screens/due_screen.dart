      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              Tab(icon: Icon(Icons.call_received_outlined, size: 16), text: 'They Owe Me'),
              Tab(icon: Icon(Icons.call_made_outlined, size: 16), text: 'I Owe'),
            ],
          ),
        ),
...
class _DebtList extends StatelessWidget {
  ...
  final DebtType type;
  const _DebtList({required this.debts, required this.currency, required this.type});
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              if (d.status != DebtStatus.settled) ...[
                TextButton(
                  onPressed: () => _showPartialPayment(ctx, p, d),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _type == DebtType.theyOwe
                      ? AppTheme.green.withOpacity(0.2) : AppTheme.card,
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                      color: _type == DebtType.theyOwe ? AppTheme.green : AppTheme.border),
                ),
                child: Column(children: [
                  Icon(Icons.call_received_outlined,
                      color: _type == DebtType.theyOwe ? AppTheme.green : AppTheme.textSecondary),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _type == DebtType.iOwe
                      ? AppTheme.red.withOpacity(0.2) : AppTheme.card,
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                      color: _type == DebtType.iOwe ? AppTheme.red : AppTheme.border),
                ),
                child: Column(children: [
                  Icon(Icons.call_made_outlined,
                      color: _type == DebtType.iOwe ? AppTheme.red : AppTheme.textSecondary),
                  const SizedBox(height: 4),
                  Text('I Owe',
                      style: TextStyle(
                          color: _type == DebtType.iOwe ? AppTheme.red : AppTheme.textSecondary,
