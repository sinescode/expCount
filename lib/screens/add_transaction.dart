...
class _AddTransactionScreenState extends State<AddTransactionScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.existing != null ? 'Edit Transaction' : 'Add Transaction'),
        actions: [
          TextButton(
            onPressed: _submit,
          ...
          children: [
            ...
            GlassCard(
              gradient: isExpense
                  ? const LinearGradient(
                      colors: [Color(0xFF2A1020), Color(0xFF1A1020)])
                  : const LinearGradient(
                      colors: [Color(0xFF0A2A20), Color(0xFF0A1A18)]),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
            ...
            GlassCard(
              child: Column(
                children: [
                  SwitchListTile(
                    title: const Text('🔒 Hidden Entry',
                        style: TextStyle(color: AppTheme.textPrimary, fontSize: 14)),
                    subtitle: const Text('Visible only in vault',
                  ...
                  SwitchListTile(
                    title: const Text('🔄 Recurring',
                        style: TextStyle(color: AppTheme.textPrimary, fontSize: 14)),
                    subtitle: const Text('Mark as recurring expense',
                        style: TextStyle(color: AppTheme.textSecondary, fontSize: 11)),
                    value: _isRecurring,
